...
func main() {
	...
	config := Config{
		...
		Repositories: []struct {
			...
			{Owner: "kokkos", Name: "kokkos-resilience"},
			{Owner: "kokkos", Name: "kokkos-remote-spaces"},
			{Owner: "kokkos", Name: "kokkos-tools"},
			{Owner: "kokkos", Name: "kokkos-tutorials"},
			{Owner: "kokkos", Name: "kokkos.github.io"},
			{Owner: "kokkos", Name: "mdspan"},
			{Owner: "kokkos", Name: "kokkos-tutorials"},
		},
		FetchDir:  "data/",
		OutputDir: "public/",
